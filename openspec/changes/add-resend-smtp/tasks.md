...
- [x] 7.3 Open the PR with `supabase/config.toml`, `supabase/templates/*.html`, `public/email/cedar-mark.png`, and the `CLAUDE.md` note. Verify: CI (Backend Tests + Frontend Tests) green; after merge, the logo URL returns the PNG (gates 5.4). — PR #101 merged + deployed 2026-09-02 (all checks green). Follow-up PR swaps the logo URL to `https://cedarchart.com/...`; re-do the dashboard paste (5.4) from that.
